...
interface MediaHandlerDemoPageProps {
  onBack: () => void
}

export function MediaHandlerDemoPage({ onBack }: MediaHandlerDemoPageProps) {
  ...
  return (
    <main className="app mediaDemo">
      <header className="demoHeader">
        <button type="button" className="secondaryButton" onClick={onBack}>Zurueck ins Menue</button>
        <h1>Media Handler Demo</h1>
        <p>Upload testen, Metadaten pruefen und Embed-Link direkt kopieren.</p>
      </header>
      ...
      {activeMedia && (
        <section className="card result">
          ...
          <dl>
            ...
            <div><dt>Groesse</dt><dd>{activeMedia.sizeBytes} Bytes</dd></div>
